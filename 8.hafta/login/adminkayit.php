...
<?php ?>
<html >
	<head> <title> Admin Kayıt Formu</title></head>
	...
	<body style='margin:0px;'>
		...
		// #################### POST Verileri başlangıc
			if($_POST){
				...
				// uyeler tablosundan herşeyi çek ama posttan gelen kullanıcı adı veya eposta varsa
						...
						if($sifre == $tekrar_sifre){	
							...
							$sonuc = mysqli_query($baglan,$sql);
								if($sonuc == 1){ // 1 == True
									...
									## sistem kayit bilgileri
									$aciklama = $kull_adi." adında yeni bir kayit oluşturuldu";
									$kadi = $_SESSION['kull_adi'];
									$yapilanislem = "kayıt eklendi";
									$sistemkayitquery = "
									...
									header('Refresh:3;url=http://localhost/login/uyeislemleri.php',true,303);
								}
								else{
		...
		<div " align="center">
			...
			">	
				...
				<h1 style="background: #20bf6b; padding:1rem 0rem; border-radius:50%;">Admin Kayıt Formu </h1>
