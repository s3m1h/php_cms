			...
			<table border="1px">
				...
				<tr align="center">
					...
					<td>
						...
						<a href="yonetici.php?do=uyeduzenle&uyeid=<?php echo $sorgu_array["id"];?>&uyeadi=<?php echo $sorgu_array["kull_adi"];?>"><img src="images/edit_30px.png"></img></a>
						
						
						<a onClick="return siluyari();" href="yonetici.php?do=uyesil&uyeid=<?php echo $sorgu_array["id"];?>&uyeadi=<?php echo $sorgu_array["kull_adi"];?>&uyeyetki=<?php echo $sorgu_array["uye_yetki"];?>"> <img src="images/trash_30px.png"></img></a>
